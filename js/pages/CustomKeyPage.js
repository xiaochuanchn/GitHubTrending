...
import LanguageDao, {FLAG_LANGUAGE} from '../expand/LanguageData';
  ...
  renderCheckBox(data, index) {
    return (
      <CheckBox
        ...
        onPress={() => this.onClick(data, index)}
        checked={data.checked}
        title={data.name}
        checkedIcon={this._checkedImage(true)}
        uncheckedIcon={this._checkedImage(false)}
      />
    );
  }
